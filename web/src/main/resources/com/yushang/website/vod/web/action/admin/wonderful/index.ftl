    ...
    <tr>
      <td class="index_view">
        [@b.form title="ui.searchForm" name="searchForm" action="!search" target="wonderfuls" theme="search"]
          ...
          [@b.textfields names="wonderful.video.name;标题,wonderful.video.author;摄影人,wonderful.video.description;内容,wonderful.video.second;时长(秒),wonderful.video.videoName;文件名"/]
