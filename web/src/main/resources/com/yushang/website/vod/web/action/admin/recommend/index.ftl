    ...
    <tr>
      <td class="index_view">
        [@b.form title="ui.searchForm" name="searchForm" action="!search" target="recommends" theme="search"]
          ...
          [@b.textfields names="recommend.video.name;标题,recommend.video.author;摄影人,recommend.video.description;内容,recommend.video.second;时长(秒),recommend.video.videoName;文件名"/]
